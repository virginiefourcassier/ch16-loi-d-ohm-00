(() => {
  ...
  // Zones de base (rectangles, puis ajustements)
  ...
  function draw(){
    ...
    // V centré + OFF voltmètre + OFF ampèremètre
    {
    ...
    // === Calibres A : zones réduites, clic circulaire ===
    const radius = 0.035 * canvas.height; // rayon commun, assez petit pour ne pas se chevaucher
    ...
    // Ces centres sont suffisamment espacés pour que les disques de rayon "radius" ne se recouvrent plus.
  ...
  canvas.addEventListener("click",(e)=>{
    ...
    // clics circulaires pour les calibres A
